This is the reference code for [CryptoNote](https://bingocoin.org) cryptocurrency protocol.

* Launch your own CryptoNote currency: [CryptoNote Starter](https://bingocoinstarter.org/)
* CryptoNote reference implementation: [CryptoNoteCoin](https://bingocoin-coin.org)
* Discussion board and support: [CryptoNote Forum](https://forum.bingocoin.org)
...
2. Fork [CryptoNote repository](https://github.com/bingocoinfoundation/bingocoin)
...
You may choose a letter (in some cases several letters) all the coin's public addresses will start with. It is defined by `CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX` constant. Since the rules for address prefixes are nontrivial you may use the [prefix generator tool](https://bingocoinstarter.org/tools.html).
